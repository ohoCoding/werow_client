...
const Footer = () => {
    return (
        <Container>
            ...
            <MainFooter>
                ...
                <ThirdBlock>
                    ...
                    <div>
                        ...
                        <Email>
                            입점 제안 문의 &nbsp;
                            <Atag>support@werow.net</Atag>
                        </Email>
                        <Email>
                            마케팅 제휴 문의 &nbsp;
                            <Atag>werow_selfTutor@gmail.com</Atag>
                        </Email>
                    </div>
                    <div>
                        <Img>
            ...
            <Bottom>
                <Text>
                    위로우 소개 | 통합 약관 | 이용 약관 | <strong>개인정보처리방침</strong>
                    <br />
                    <br />
                    대표: 권혁문 | 주소:서울시 마포구 (주)위로우 | 사업자등록번호:(입력해야함) 사업자 정보 확인
                    <br />
                    개인정보 보호 책임자: 권혁문 | 예시: 통신판매업 신고번호:제2017-마포-0722
                    <br />
                    Copyright © WEROW, Inc. All Rights Reserved.
                    <br />
                </Text>
            </Bottom>
        </Container>
